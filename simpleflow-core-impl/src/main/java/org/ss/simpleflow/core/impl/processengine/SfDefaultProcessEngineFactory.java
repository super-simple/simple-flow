...
import org.ss.simpleflow.core.aspect.SfLineAspect;
...
public class SfDefaultProcessEngineFactory<NODE_ID, LINE_ID, PROCESS_CONFIG_ID,
        ...
        NODE_EXECUTION_ID, LINE_EXECUTION_ID, PROCESS_EXECUTION_ID> implements SfProcessEngineFactory<NODE_ID, LINE_ID, PROCESS_CONFIG_ID, NODE_CONFIG, LINE_CONFIG, PROCESS_CONFIG_GRAPH, PROCESS_CONFIG, NODE_EXECUTION_ID, LINE_EXECUTION_ID, PROCESS_EXECUTION_ID> {
    @Override
    public SfProcessEngine<NODE_ID, LINE_ID, PROCESS_CONFIG_ID, NODE_CONFIG, LINE_CONFIG, PROCESS_CONFIG_GRAPH, PROCESS_CONFIG, NODE_EXECUTION_ID, LINE_EXECUTION_ID, PROCESS_EXECUTION_ID> createProcessEngine(
            ...
            List<SfLineAspect<NODE_ID, LINE_ID, PROCESS_CONFIG_ID, NODE_CONFIG, LINE_CONFIG, PROCESS_CONFIG_GRAPH, PROCESS_CONFIG, LINE_EXECUTION_ID, PROCESS_EXECUTION_ID>> lineAspectList,
        ...
        return new SfDefaultProcessEngine<>(processEngineConfig, controlLineFactory, dataLineFactory,
                                            ...
                                            contextFactory,
                                            lineAspectList, nodeAspectList, processAspectList);
    }
}
